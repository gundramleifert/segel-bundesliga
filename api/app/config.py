...
class Settings(BaseSettings):
    ...
    # Where runtime uploads (sailor photos, ...) are stored on local disk. A file's mere
    # existence at a deterministic path (e.g. "sailors/{sailor_id}.jpg") *is* the "has a
    # photo" state — no database column needed. Not versioned (see .gitignore); an
    # S3-compatible store remains a future option, see docs/userstories.md, Story S-2.
